...
const words = [
    ...
    { word: 'Backup', hint: 'Linguagem de programação' },
    { word: 'Chatbot', hint: 'Inteligência Artificial' },
    { word: 'Cliente', hint: 'Consumidor' },
    { word: 'Código', hint: 'Linguagem de programação' },
    { word: 'Git', hint: 'Linguagem de programação' },
    { word: 'Hardware', hint: 'Computador' },
    { word: 'Repositório', hint: 'Linguagem de programação' },
    { word: 'Console', hint: 'Linguagem de programação' },
    { word: 'Terminal', hint: 'Linguagem de programação' },
    { word: 'Biblioteca', hint: 'Leitura' },
    { word: 'kaua', hint: 'eu' }
];

const hangmanImages = [
    "forca_boneco/forca0.png",
    "forca_boneco/forca1.png",
    "forca_boneco/forca2.png",
    "forca_boneco/forca3.png",
    "forca_boneco/forca4.png",
    "forca_boneco/forca5.png",
    "forca_boneco/forca6.png",
];
let selectedWord;
let hint;
let guessedLetters = [];
